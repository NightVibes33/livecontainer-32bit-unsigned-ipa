...
void SecItemGuestHooksInit(void)  {
    ...
    if(keychainGroupId == 0) {
        accessGroup = [NSString stringWithFormat:@"%@.com.nightvibes33.livecontainer32.shared", groupId];
    } else {
        accessGroup = [NSString stringWithFormat:@"%@.com.nightvibes33.livecontainer32.shared.%d", groupId, keychainGroupId];
    }
