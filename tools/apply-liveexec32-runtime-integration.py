...
lc = repo / 'LiveContainer/LCBootstrap.m'
le = repo / 'build/LiveExec32/main.cpp'
...
le.write_text(le_text)
print('patched LiveContainer and LiveExec32 launch integration')
